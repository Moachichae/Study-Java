...
public class StringMain04 {
	...
	public static void main(String[] args) {
		...
		// compareToIgnorCase(String) : 해당 문자열과 대소문자 구분없이 비교 후
		//								서로 다른 문자의 개수 리턴
		String str10 = "abc";
		String str11 = "bbc";
