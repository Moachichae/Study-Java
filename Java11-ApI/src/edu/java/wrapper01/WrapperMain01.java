...
// - Wrapper 클래스를 사용하는 이우 :
// 1. 클래스의 메소드(기능), 상수(public static final)을 사용하기 위해서
// 2. 매개변수 Object를 갖는 메소드의 매개변수로 사용하기 위해서
...
public class WrapperMain01 {
	...
	public static void main(String[] args) {
		...
		System.out.println("====================================");
		// parseXxx():
		// 문자열을 전달받아서, 기본 자료형으로 리턴해주는 static 메소드
		int x = Integer.parseInt("123456"); // 정수형태의 문자열만 가능
